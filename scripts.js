...
var cars_Ref = firebase.database().ref('/LAMPARAS_E3_test_v2');


var dataConductores = firebase.database().ref('/LAMPARAS_E3_test_v2');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_test_E3_v2');
